 ...
 */
function requireResource(resource, name = "Resource") {
 ...
 */
function requireAuth(condition, message = "Authentication required") {
	if (!condition) {
 ...
 */
function requirePermission(condition, message = "Access denied") {
	if (!condition) {
